...
public record DefinitionDeduplicateResults {
    ...
    public ImmutableDictionary<PrefixSegment, PrefixSegment> Prefixes { get; init; } =
        ImmutableDictionary<PrefixSegment, PrefixSegment>.Empty;

    public ImmutableDictionary<StringSegment, StringSegment> Strings { get; init; } =
        ImmutableDictionary<StringSegment, StringSegment>.Empty;

    public ImmutableDictionary<ImmutableHashSet<Category>, ImmutableHashSet<Category>> Categories { get; init; } =
        ImmutableDictionary<ImmutableHashSet<Category>, ImmutableHashSet<Category>>.Empty;
